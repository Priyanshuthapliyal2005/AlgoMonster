    ...
    <>
      {algorithms.map((data) => {
        return (
          ...
          >
            <h2 className="font-space uppercase text-blue text-center text-[1.1rem] cursor-pointer mb-[5px]">
              {data.name}
            </h2>
            <div
              className={
                ...
                return (
                  ...
                  >
                    {currAlgoId != algorithm.id ? (
                      <div className="w-full border-2 border-bg-2 hover:border-blue hover:border-2 hover:bg-blue-bg font-space text-text-1 text-center text-[0.95rem] ">
                        {algorithm.name}
                      </div>
                    ) : (
                      <div className="w-full border-2 border-bg-2 bg-blue-bg-4 hover:border-blue font-space text-text-1 text-center text-[0.95rem] ">
                        {algorithm.name}
                      </div>
                    )}
                  </Link>
